...
public class RecipeList_Old extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView_recipeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> adapterView,final View view,final int i,final long l) {
                ...
                Intent viewRecipe = new Intent(RecipeList_Old.this, ViewRecipe.class);
        ...
        listView_recipeList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, final View view, final int i, final long l) {
                ...
                RecipeList_Old.this.startActionMode(new ActionMode.Callback() {
                    @Override
                    ...
                    public boolean onActionItemClicked(ActionMode actionMode, MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.action_deleteRecipe:
                                ...
                                new AlertDialog.Builder(RecipeList_Old.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.action_addRecipe:
                ...
                Intent loadAddRecipe = new Intent(RecipeList_Old.this, AddRecipe.class);
                RecipeList_Old.this.startActivity(loadAddRecipe);
                break;
            default:
                break;
        }
